...
image = Image.open('Design 2 Assets\csm 103.png')
new_image = image.resize((282, 422))
new_image.save('Design 2 Assets\csm 103.png')
yy = True
images = []
...
root.iconbitmap('Design 2 Assets\csm icon.ico')
...
img = ImageTk.PhotoImage(Image.open("Design 2 Assets\csm poster.jpg"))
img2 = ImageTk.PhotoImage(Image.open("Design 2 Assets\csm 103.png"))
