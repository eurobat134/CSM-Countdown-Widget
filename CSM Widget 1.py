...
image = Image.open('Design 1 Assets\csm poster.jpg')
new_image = image.resize((282, 422))
new_image.save('Design 1 Assets\csm poster.jpg')
yy = True
images = []
...
root.iconbitmap('Design 1 Assets\csm icon.ico')
...
img = ImageTk.PhotoImage(Image.open("Design 1 Assets\csm poster.jpg"))
var = IntVar()
